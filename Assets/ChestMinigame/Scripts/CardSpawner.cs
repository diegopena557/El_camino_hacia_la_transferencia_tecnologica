...
public class CardSpawner : MonoBehaviour
{
    ...
    private CategoryCards hardPool;           // Pool nivel dif�cil (otras escuelas)
    ...
    void Start()
    {
        ...
        // No iniciar autom�ticamente - esperar selecci�n de escuela
        // SpawnSet();
    }
    ...
    /// <summary>
    /// Configura las escuelas y pools de cartas seg�n la selecci�n del jugador
    /// </summary>
    public void SetupSchools(SchoolData selectedSchool, SchoolCardManager manager)
    {
        ...
        // Pool DIF�CIL: Cartas de todas las otras escuelas
    ...
    IEnumerator SpawnSequence()
    {
        ...
        // Obtener 2 cartas de cada categor�a
    ...
    void AddRandomFromPool(List<GameObject> pool, int amount, List<GameObject> result)
    {
        ...
        {
            Debug.LogWarning($"Pool vac�o. No se pueden agregar cartas.");
            return;
        }
